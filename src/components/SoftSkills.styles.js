...
export const SoftSkillName = styled.h3`
  color: #fff;
  font-size: 1.4rem;
  margin-bottom: 1rem;
`;

export const SoftSkillLevel = styled.div`
...
export const SoftSkillBar = styled.div`
  height: 100%;
...
export const SoftSkillPercent = styled.span`
  color: #6366f1;
  font-weight: bold;
  font-size: 0.9rem;
`;
